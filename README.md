...
<img width="1886" height="841" alt="image" src="https://github.com/user-attachments/assets/dfa8b67c-0a05-4afd-8238-4a115981adc6" />
...
<img width="1542" height="337" alt="image" src="https://github.com/user-attachments/assets/173fa252-1f03-4c00-8db6-f6c05109b7fe" />

### Collaboration with Event Organizers

- **Concept**: Partner with event organizers to release exclusive NFT tickets.
  <img width="1190" height="817" alt="image" src="https://github.com/user-attachments/assets/a7155f4a-57e1-4975-8733-7588f75c74dc" />

  <img width="1649" height="890" alt="image" src="https://github.com/user-attachments/assets/ac607457-20c3-483d-aefb-f571e261a0ba" />
...
3. Set up environment variables:
    ...
    ```
    Edit `.env.local` with  NEXT_PUBLIC_GRAPHQL_ENDPOINT='https://api.andromedaprotocol.io/graphql/testnet'
